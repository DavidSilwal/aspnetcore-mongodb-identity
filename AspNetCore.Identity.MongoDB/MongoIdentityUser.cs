...
namespace Dnx.Identity.MongoDB
{
    ...
    public class MongoIdentityUser
    {
        ...
        public MongoIdentityUser(string userName, MongoUserEmail email) : this(userName)
        {
            ...
            this.Claims = new List<MongoUserClaim>();
        ...
        //public virtual void SetClaimInfoes(string type,string value)
        //{
        //   MongoUserClaim claim = new  MongoUserClaim(type, value);
        //    SetClaimInfoes(claim);
        //}
          
        //public virtual void SetClaimInfoes(MongoUserClaim mongoUserCaim)
        //{
        //    ClaimInfoes = mongoUserCaim;
        //}
